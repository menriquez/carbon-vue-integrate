...
}tab:ref: '#', role: 'presentation', tabIndex: 0, , };
...
tools and resources, human interface guidelines, and a
   ...
   <div class="bx--col-md-4 bx--offset-lg-1 bx--col-lg-8">
      <mg lass="landing-page__illo"
src="../../assets/tab-illo.png"
alt="Carbon illustration"
/>
        </div
    <cv-tab label="Design">
<div class="bx--grid bx--grid--no-gutter bx--grid<div class="bx--row landing-page__ta<div class="bx--col-lg-16">
